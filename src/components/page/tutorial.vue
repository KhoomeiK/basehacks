<template>
    ...
    <section id="education">
      ...
      <ul id="curriculum-index">
        ...
        <li><strong>Lesson 1</strong> &mdash; Tips for Communication</li>
          <p>Listening:<br>
            Active listening and Verbal listening: Learn to use virtual listening to show attention and to encourage more exploration from the client. In video or audio calls,you can show that you are listening by giving verbal cues such as ‘Ok’, ‘Uh huh”, etc. It can also be in the form of paraphrasing or repeating a word of emotion that the client has just said.</p>

          <p>Asking Questions:<br>
            Questions are helpful because they allow you to learn more about your client. The type of questions that you ask will set the tone of the session and the entire counseling process. Questions occur in two forms.<br>
              Closed: A closed question is the practice of asking a question that can be answered as a ‘yes’ or ‘no’. Closed questions should generally be avoided in the counseling relationship, as they do not encourage deeper exploration.<br>
              Open: An open question is necessary to gather information. An open question is one that cannot be answered with a simple ‘yes’ or ‘no’ and it requires reflection or exploration on the client’s end. Every open question should be intentional and therapeutic. These questions usually begin with ‘how’ or ‘why’.</p>
        ...
        <li><strong>Lesson 2</strong> &mdash; Anxiety & Stress</li>
        <p>
        ...
        <li><strong>Lesson 3</strong> &mdash; Depression</li>
        <p>
        ...
        <li><strong>Lesson 4</strong> &mdash; Emotional & Physical Abuse</li>
        <p>
        ...
        <li><strong>Lesson 5</strong> &mdash; Sexuality and its Effect</li>
        <p>
        ...
        <li><strong>Lesson 6</strong> &mdash; Self Harm</li>
        <p>
        ...
        <li><strong>Lesson 7</strong> &mdash; Suicidal Individuals</li>
        <p>
        ...
        <li><strong>Lesson 8</strong> &mdash; Mindset & Pledge</li>
        <p>
